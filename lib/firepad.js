...
firepad.Firepad = (function(global) {
  ...
  function Firepad(ref, place, options) {
    ...
    this.customButtons = this.getOption('customButtons', []);
  ...
  Firepad.prototype.addToolbar_ = function() {
    this.toolbar = new RichTextToolbar(this.imageInsertionUI, this.customButtons);
    ...
    this.customButtons.forEach(function (btn) {
      this.toolbar.on(btn.name, btn.handler, this);
    }.bind(this));
