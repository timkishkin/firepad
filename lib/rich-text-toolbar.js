...
firepad.RichTextToolbar = (function(global) {
  ...
  function RichTextToolbar(imageInsertionUI, customButtons) {
  ...
  RichTextToolbar.prototype.makeElement_ = function() {
    ...
    self.customButtons.forEach(function (btn) {
      toolbarOptions.push(utils.elt('div', [self.makeButton_(btn.name)], { 'class': 'firepad-btn-group' }));
      RichTextToolbar.prototype.allowedEvents_.push(btn.name);
    }); 
